...
public class ScoreWidgetIntentService extends IntentService implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        int[] appWidgetIds = appWidgetManager
                .getAppWidgetIds(new ComponentName(this, ScoreAppProvider.class));
        ...
        Cursor data = getContentResolver().query(dateUri, SCORE_COLUMNS, DatabaseContract.scores_table.MATCH_DAY, date, null);
